...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Owner\PycharmProjects\VehicleManager\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Owner\PycharmProjects\VehicleManager\venv\Scripts\deactivate.nu'
